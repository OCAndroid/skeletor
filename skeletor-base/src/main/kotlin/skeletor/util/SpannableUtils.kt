...
internal fun background(@ColorInt color: Int, radius: Float, lineSpacing: Float, s: CharSequence, inverse: Boolean) = span(s, RoundedBackgroundColorSpan(color, radius, lineSpacing, inverse))
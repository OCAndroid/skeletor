...
import skeletor.api.generateSkeleton
import skeletor.custom.SkeletorView
import skeletor.sample.databinding.ItemJourneyBinding
import skeletor.sample.model.Journey
import skeletor.sample.utils.State
...
class JourneyListAdapter(private val clickListener: (Journey) -> Unit) :
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        when (getItemViewType(position)) {
            ...
            TYPE_SKELETON -> (holder as SkeletonViewHolder).skeletorView.showSkeleton()
        }
    }
